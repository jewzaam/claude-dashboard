...
.PHONY: default help install install-dev install-hooks uninstall clean format format-check lint typecheck test test-verbose coverage check markdown-lint links mutation mutation-report run
