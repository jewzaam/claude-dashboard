...
**Status**: Implemented
**Version**: 0.2.0
**Feature**: 001-session-dashboard
**Input**: Voice transcript (see `docs/raw-prompt.md`)
...
- **Session**: A running Claude Code process. Attributes: PID, CWD, main process status, parent window handle, container process type, session ID, slug (human-readable name), start time.
